...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-*6l-$by1isnzud20w1u@35tc7aurhm*atgbc17scd2i^mwk(o)",
)
...
MIDDLEWARE = [
    ...
    "showcase.interface.middleware.ApiJsonErrorMiddleware",
]
...
if os.environ.get("POSTGRES_HOST"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("POSTGRES_DB", "showcase"),
            "USER": os.environ.get("POSTGRES_USER", "showcase"),
            "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "showcase"),
